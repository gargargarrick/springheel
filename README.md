...
* Everything a comic (not a blog) needs. Making a characters page is so quick, you'll never have an out-of-date one again! Sections for creator commentaries, extra galleries, and guest comics are included by default too. Archives can be divided by chapter (if you have them) and/or date.
